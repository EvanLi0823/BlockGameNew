# Win_Fixed Prefab 结构文档

**生成时间**: 2026-03-11 13:18:00
**文件路径**: `Assets/BlockPuzzleGameToolkit/Resources/Popups/Win_Fixed.prefab`
**文件类型**: Prefab
**GameObject总数**: 17
**根节点数量**: 1
...
```
● **Win_Fixed** `[Animator, CanvasGroup, CanvasRenderer, MonoBehaviour... +1]`
