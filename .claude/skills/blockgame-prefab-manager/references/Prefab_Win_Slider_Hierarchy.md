# Win_Slider Prefab 结构文档

**生成时间**: 2026-03-11 13:18:00
**文件路径**: `Assets/BlockPuzzleGameToolkit/Resources/Popups/Win_Slider.prefab`
**文件类型**: Prefab
**GameObject总数**: 17
**根节点数量**: 1
...
```
● **Win_Slider** `[Animator, CanvasGroup, CanvasRenderer, MonoBehaviour... +1]`
  ├─ **Content** `[Animator, CanvasRenderer]`
    ...
    ├─ **txt_multiple** `[CanvasRenderer, MonoBehaviour]`
      ├─ **txt_x** `[CanvasRenderer, MonoBehaviour]`
