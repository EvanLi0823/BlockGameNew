# CommonRewardPopup Prefab 结构文档

**生成时间**: 2026-03-11 13:17:58
**文件路径**: `Assets/BlockPuzzleGameToolkit/Resources/Popups/CommonRewardPopup.prefab`
**文件类型**: Prefab
**GameObject总数**: 17
**根节点数量**: 1
...
CommonRewardPopup Prefab 包含以下主要组件。
...
### 根节点 1: CommonRewardPopup

```
● **CommonRewardPopup** `[Animator, CanvasGroup, CanvasRenderer, MonoBehaviour... +1]`
  ├─ **Content** `[Animator, CanvasRenderer]`
    ├─ **img_guang** `[CanvasRenderer, MonoBehaviour]`
    ├─ **img_reward** `[CanvasRenderer, MonoBehaviour]`
    ├─ **img_white** `[CanvasRenderer, MonoBehaviour]`
    ├─ **tmp_reward** `[CanvasRenderer, MonoBehaviour, MonoBehaviour]`
    ...
    ├─ **btn_noclaim** `[CanvasRenderer, MonoBehaviour, MonoBehaviour, MonoBehaviour]`
      ├─ **Text (TMP)** `[CanvasRenderer, MonoBehaviour]`
    ├─ **txt_multiple** `[CanvasRenderer, MonoBehaviour]`
      ├─ **tmp_x** `[CanvasRenderer, MonoBehaviour]`
```
