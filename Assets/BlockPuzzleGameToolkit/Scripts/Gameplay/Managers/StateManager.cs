...
namespace BlockPuzzleGameToolkit.Scripts.Gameplay
{
    public class StateManager : SingletonBehaviour<StateManager>
    {
        ...
        private EScreenStates _currentState = EScreenStates.Loading;  // 默认初始状态为Loading

        public override void Awake()
        {
            base.Awake();
            // 设置初始状态为Loading
            CurrentState = EScreenStates.Loading;
        }
        ...
        public EScreenStates CurrentState
        {
            ...
            {
                _currentState = value;
                SetActiveState(loadingScreens, _currentState == EScreenStates.Loading);
