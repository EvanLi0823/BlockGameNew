...
namespace BlockPuzzleGameToolkit.Scripts.Popups
{
    public class MenuManager : SingletonBehaviour<MenuManager>
    {
        ...
        {
            base.Awake();
            // DontDestroyOnLoad(this); // 移除错误调用，基类已处理
        }
        ...
        {
            // FadeOut is handled in ClosePopup method after the popup is removed from stack
        }
        ...
        public Popup ShowPopup(Popup popupPrefab, Action onShow = null, Action<EPopupResult> onClose = null)
        {
            ...
            {
                fader.FadeIn(popup.FadeAlpha, popup.FadeInDuration);
            }
        ...
        public Popup ShowPopupDelayed(Popup popupPrefab, Action onShow = null, Action<EPopupResult> onClose = null)
        {
            ...
            {
                fader.FadeIn(popupPrefab.FadeAlpha, popupPrefab.FadeInDuration);
            }
        ...
        private void ClosePopup(Popup popupClose)
        {
            ...
            // Remove IsFaded() check - always fade out when no popups remain
        ...
        public void FadeIn(float fadeAlpha = 0.6f, Action action = null)
        {
