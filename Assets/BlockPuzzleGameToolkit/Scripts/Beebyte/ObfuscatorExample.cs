...
public class ObfuscatorExample : MonoBehaviour
{
    ...
    // RPC example is not available in Unity 2018.2 or newer as the old networking system was removed.
    // For modern Unity networking (Netcode for GameObjects, Mirror, etc.),
    // consult the Obfuscator documentation for specific integration instructions.
#else
